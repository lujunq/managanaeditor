...
if (($level == "super") || ($level == "super") || ($level == "super")) {
	$query = "SELECT * FROM dis_playlist WHERE ply_community='$community' AND ply_id='$id' AND ply_index='$index' LIMIT 1";
} else {
	$query = "SELECT * FROM dis_playlist WHERE ply_community='$community' AND ply_id='$id' AND ply_index='$index' AND ply_authorid='" . $_SESSION['usr_id'] . "' LIMIT 1";
}
